...
`;var ai=r(6396);const li=ie(o.n(ai)())`
  && {
    box-sizing: border-box;
    min-width: 100px;
    outline: none;
...
`,pi=ie.span`
  ...
  font-size: 0.929em;
  color: black;
`;var ui=r(6162);const di=ie(ui.Tabs)`
  > ul {
    list-style: none;
    padding: 0;
    margin: 0;
...
`;class cc extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(ti,null,e.createElement(ac,null," Response Headers "),e.createElement("tbody",null,O(t,((t,r)=>e.createElement(wa,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var pc=Object.defineProperty,uc=Object.getOwnPropertySymbols,dc=Object.prototype.hasOwnProperty,hc=Object.prototype.propertyIsEnumerable,mc=(e,t,r)=>t in e?pc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class fc extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(_o,{key:"header"},"Response Schema: ",e.createElement(Mi,((e,t)=>{for(var r in t||(t={}))dc.call(t,r)&&mc(e,r,t[r]);if(uc)for(var r of uc(t))hc.call(t,r)&&mc(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(Ji,{source:t}),e.createElement(Vs,{extensions:r}),e.createElement(cc,{headers:n}),e.createElement(Jl,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(Ua,{skipWriteOnly:!0,key:"schema",schema:t}))))}}const yc=(0,$s.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,code:a,expanded:l,content:c}=t,p=e.useMemo((()=>void 0===c?[]:c.mediaTypes.filter((e=>void 0!==e.schema))),[c]),u=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==p.length||s)),[r,n,p,s]);return e.createElement("div",null,e.createElement(ic,{onClick:()=>t.toggle(),type:o,empty:u,title:i||"",code:a,opened:l}),l&&!u&&e.createElement(sc,null,e.createElement(fc,{response:t})))})),gc=ie.h3`
  ...
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class bc extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(gc,null,F(r?"callbackResponses":"responses")),t.map((t=>e.createElement(yc,{key:t.code,response:t})))):null}}const xc=ie.ul`
  display: inline;
  list-style: none;
  padding: 0;
...
`,Oc=ie.span`
  ...
  ${Fi};
`;class Ec extends e.PureComponent{render(){const t=this.props.security;return e.createElement(Oc,null,t.schemes.length?t.schemes.map((t=>e.createElement(wc,{key:t.id},e.createElement(zo,{to:t.sectionId},t.displayName),t.scopes.length>0&&" (",e.createElement(xc,null,t.scopes.map((t=>e.createElement("li",{key:t},e.createElement(vc,null,t))))),t.scopes.length>0&&") "))):e.createElement(wc,null,"None"))}}const kc=ie.div`
  flex: 1 1 auto;
`,Sc=ie.div`
  width: ${e=>e.theme.schema.defaultDetailsWidth};
  ${oe.lessThan("small")`
...
`,$c=ie.div`
  ...
  ${oe.lessThan("small")`
    flex-direction: column;
  `}
`;class Cc extends e.PureComponent{render(){const t=this.props.securities;return t.length?e.createElement($c,null,e.createElement(kc,null,e.createElement(Rc,null,"Authorizations: ")),e.createElement(Sc,null,t.map(((t,r)=>e.createElement(Ec,{key:r,security:t}))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let Ac=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(Ml,null,o&&e.createElement(Pc,null,void 0!==r&&e.createElement(Ji,{source:r}),n&&e.createElement(qs,{externalDocs:n})),e.createElement(Vl,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(Vs,{extensions:t.extensions}),e.createElement(Cc,{securities:t.security}),e.createElement(tc,{parameters:t.parameters,body:t.requestBody}),e.createElement(bc,{responses:t.responses,isCallback:t.isCallback}))}};Ac=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Ac);const Pc=ie.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let jc=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Ll,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement(Ac,{operation:this.props.callbackOperation}))}};jc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],jc);class Ic extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Tc,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(jc,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Tc=ie.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let _c=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;const r=({children:t})=>this.props.label?e.createElement(Os,null,e.createElement(ws,null,this.props.label),t):t;return e.createElement(e.Fragment,null,e.createElement(r,null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};_c=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],_c);var Dc=Object.defineProperty,Lc=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Mc=Object.prototype.hasOwnProperty,Nc=Object.prototype.propertyIsEnumerable,Fc=(e,t,r)=>t in e?Dc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let zc=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(Mi,((e,t)=>{for(var r in t||(t={}))Mc.call(t,r)&&Fc(e,r,t[r]);if(Lc)for(var r of Lc(t))Nc.call(t,r)&&Fc(e,r,t[r]);return e})({Label:vs,Dropdown:Es},t))}render(){const t=this.props.content;return void 0===t?null:e.createElement(Jl,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(Ss,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};zc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],zc);class Bc extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>wn(e)));return t?e.createElement(qc,null,e.createElement(zc,{content:t.requestBodyContent})):null}}const qc=ie.div`
  margin-top: 15px;
`;var Qc=Object.defineProperty,Uc=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Wc=Object.prototype.hasOwnProperty,Vc=Object.prototype.propertyIsEnumerable,Hc=(e,t,r)=>t in e?Qc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Jc=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(Mi,((e,t)=>{for(var r in t||(t={}))Wc.call(t,r)&&Hc(e,r,t[r]);if(Uc)for(var r of Uc(t))Vc.call(t,r)&&Hc(e,r,t[r]);return e})({Label:vs,Dropdown:Es},t))}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(To,null," Callback payload samples "),e.createElement(Yc,null,e.createElement(_c,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(Bc,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};Jc.contextType=me,Jc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Jc);const Yc=ie.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Gc=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(To,null," ",F("requestSamples")," "),e.createElement(di,{defaultIndex:0},e.createElement(ui.TabList,{hidden:o},r.map((t=>e.createElement(ui.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(ui.TabPanel,{key:t.lang+"_"+(t.label||"")},wn(t)?e.createElement("div",null,e.createElement(zc,{content:t.requestBodyContent})):e.createElement(ys,{lang:t.lang,source:t.source}))))))||null}};Gc.contextType=me,Gc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Gc),Object.defineProperty,Object.getOwnPropertyDescriptor;let Xc=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(To,null," ",F("responseSamples")," "),e.createElement(di,{defaultIndex:0},e.createElement(ui.TabList,null,r.map((t=>e.createElement(ui.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(ui.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(zc,{content:t.content})))))))||null}};Xc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Xc),Object.defineProperty,Object.getOwnPropertyDescriptor;const Zc=ie.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`;let Kc=class extends e.Component{render(){const{operation:t}=this.props,{name:r,description:n,deprecated:o,externalDocs:i,isWebhook:s}=t,a=!(!n&&!i);return e.createElement(me.Consumer,null,(l=>e.createElement(Co,null,e.createElement(ko,null,e.createElement(Io,null,e.createElement(qo,{to:t.id}),r," ",o&&e.createElement(Vo,{type:"warning"}," Deprecated "),s&&e.createElement(Vo,{type:"primary"}," Webhook ")),l.pathInMiddlePanel&&!s&&e.createElement(Vl,{operation:t,inverted:!0}),a&&e.createElement(Zc,null,void 0!==n&&e.createElement(Ji,{source:n}),i&&e.createElement(qs,{externalDocs:i})),e.createElement(Vs,{extensions:t.extensions}),e.createElement(Cc,{securities:t.security}),e.createElement(tc,{parameters:t.parameters,body:t.requestBody}),e.createElement(bc,{responses:t.responses}),e.createElement(Ic,{callbacks:t.callbacks})),e.createElement($o,null,!l.pathInMiddlePanel&&!s&&e.createElement(Vl,{operation:t}),e.createElement(Gc,{operation:t}),e.createElement(Xc,{operation:t}),e.createElement(Jc,{callbacks:t.callbacks})))))}};Kc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Kc);var ep=Object.defineProperty,tp=Object.getOwnPropertyDescriptor,rp=Object.getOwnPropertySymbols,np=Object.prototype.hasOwnProperty,op=Object.prototype.propertyIsEnumerable,ip=(e,t,r)=>t in e?ep(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,sp=(e,t)=>{for(var r in t||(t={}))np.call(t,r)&&ip(e,r,t[r]);if(rp)for(var r of rp(t))op.call(t,r)&&ip(e,r,t[r]);return e},ap=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?tp(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&ep(t,r,i),i};let lp=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(cp,{key:t.id,item:t})))}};lp=ap([$s.observer],lp);let cp=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":default:r=e.createElement(up,sp({},this.props));break;case"operation":r=e.createElement(dp,{item:t})}return e.createElement(e.Fragment,null,r&&e.createElement(So,{id:t.id,underlined:"operation"===t.type},r),t.items&&e.createElement(lp,{items:t.items}))}};cp=ap([$s.observer],cp);const pp=t=>e.createElement(ko,{compact:!0},t);let up=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?Io:jo;return e.createElement(e.Fragment,null,e.createElement(Co,null,e.createElement(ko,{compact:!1},e.createElement(i,null,e.createElement(qo,{to:this.props.item.id}),t))),e.createElement(wl,{source:r||"",htmlWrap:pp}),n&&e.createElement(Co,null,e.createElement(ko,null,e.createElement(qs,{externalDocs:n}))))}};up=ap([$s.observer],up);let dp=class extends e.Component{render(){return e.createElement(Kc,{operation:this.props.item})}};dp=ap([$s.observer],dp);var hp=Object.defineProperty,mp=Object.defineProperties,fp=Object.getOwnPropertyDescriptor,yp=Object.getOwnPropertyDescriptors,gp=Object.getOwnPropertySymbols,bp=Object.prototype.hasOwnProperty,xp=Object.prototype.propertyIsEnumerable,vp=(e,t,r)=>t in e?hp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,wp=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?fp(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&hp(t,r,i),i};let Op=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&u(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement($l,{onClick:this.activate,depth:t.depth,"data-item-id":t.id},"operation"===t.type?e.createElement(Ep,(n=((e,t)=>{for(var r in t||(t={}))bp.call(t,r)&&vp(e,r,t[r]);if(gp)for(var r of gp(t))xp.call(t,r)&&vp(e,r,t[r]);return e})({},this.props),mp(n,yp({item:t})))):e.createElement(Al,{depth:t.depth,active:t.active,type:t.type,ref:this.ref},e.createElement(Pl,{title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(Wo,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(Ap,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};Op=wp([$s.observer],Op);let Ep=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef()}componentDidUpdate(){this.props.item.active&&this.ref.current&&u(this.ref.current)}render(){const{item:t}=this.props;return e.createElement(Al,{depth:t.depth,active:t.active,deprecated:t.deprecated,ref:this.ref},t.isWebhook?e.createElement(kl,{type:"hook"},F("webhook")):e.createElement(kl,{type:t.httpVerb},wt(t.httpVerb)),e.createElement(Pl,{width:"calc(100% - 38px)"},t.sidebarLabel,this.props.children))}};Ep=wp([$s.observer],Ep);var kp=Object.defineProperty,Sp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Rp=Object.prototype.hasOwnProperty,$p=Object.prototype.propertyIsEnumerable,Cp=(e,t,r)=>t in e?kp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Ap=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(Rl,((e,t)=>{for(var r in t||(t={}))Rp.call(t,r)&&Cp(e,r,t[r]);if(Sp)for(var r of Sp(t))$p.call(t,r)&&Cp(e,r,t[r]);return e})({className:n,style:this.props.style,expanded:o},r?{role:"navigation"}:{}),t.map(((t,r)=>e.createElement(Op,{key:r,item:t,onActivate:this.props.onActivate}))))}};Ap=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Ap),Object.defineProperty,Object.getOwnPropertyDescriptor;let Pp=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(Ai,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(Ap,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(jl,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},"Documentation Powered by Redocly")))}};Pp.contextType=me,Pp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Pp);const jp=({open:t})=>{const r=t?8:-4;return e.createElement(Tp,null,e.createElement(Ip,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(Ip,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},Ip=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),Tp=ie.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;let _p;Object.defineProperty,Object.getOwnPropertyDescriptor,l&&(_p=o(612));const Dp=_p&&_p(),Lp=ie.div`
...
`;let Np=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Dp&&Dp.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Dp&&Dp.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?X.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Lp,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Mp,{onClick:this.toggleNavMenu},e.createElement(jp,{open:t})))}};Np.contextType=me,Np=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([$s.observer],Np);const Fp=ie.div`
...
`,Vp=ie.i`
  ...
  font-style: normal;
  color: '#666';
`;var Hp=Object.defineProperty,Jp=Object.getOwnPropertyDescriptor;class Yp extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const t=e.target.value;t.length<3?this.clearResults(t):this.setState({term:t},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.map((e=>({item:this.props.getItemById(e.meta),score:e.score})));return r.sort(((e,t)=>t.score-e.score)),e.createElement(qp,{role:"search"},this.state.term&&e.createElement(Vp,{onClick:this.clear},"\xd7"),e.createElement(Up,null),e.createElement(Qp,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(Ai,{options:{wheelPropagation:!1}},e.createElement(Wp,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(Op,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(Wp,{"data-role":"search:results"},F("noResultsFound")):null)}}((e,t,r,n)=>{for(var o,i=Jp(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&Hp(t,r,i)})([Ee.bind,(0,Ee.debounce)(400)],Yp.prototype,"searchCallback");class Gp extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(ne,{theme:n.theme},e.createElement(Lo,{value:s},e.createElement(fe,{value:n},e.createElement(Fp,{className:"redoc-wrap"},e.createElement(Np,{menu:r,className:"menu-content"},e.createElement(ml,{info:t.info}),!n.disableSearch&&e.createElement(Yp,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(Pp,{menu:r})),e.createElement(zp,{className:"api-content"},e.createElement(pl,{store:s}),e.createElement(lp,{items:r.items})),e.createElement(Bp,null)))))}}Gp.propTypes={store:he.instanceOf(nl).isRequired};const Xp=function(t){const{spec:r,specUrl:n,options:i={},onLoaded:s}=t,a=Y(i.hideLoading,!1),l=new X(i);if(void 0!==l.nonce)try{o.nc=l.nonce}catch(e){}return e.createElement(le,null,e.createElement(No,{spec:r,specUrl:n,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(de,{color:l.theme.colors.primary.main}):e.createElement(Gp,{store:r}))))}}(),i}()}}]);