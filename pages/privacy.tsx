      ...
      header={
        <div className="pure-grid squiggles">
          <div className="pure-u-1 pure-u-md-2-5">
            ...
            <Hero>How we collect and use your information.</Hero>
          </div>
        </div>
      }
    >
      <div className="pure-grid container">
        <div className="pure-u-1 pure-u-md-1-5 sticky">
          <SidebarMenu title="Contents">
            ...
            <SidebarMenuItem href="#pii">Personally-Identifying Information</SidebarMenuItem>
            <SidebarMenuItem href="#statistics">
              Aggregated Statistics
            </SidebarMenuItem>
            <SidebarMenuItem href="#pii2">Protection of Personally-Identifying Information</SidebarMenuItem>
        ...
        <div className="pure-u-1 pure-u-md-4-5">
          ...
          <ul>
            ...
            <li>
              ...
              for the on-going operation of the service.
            </li>
          </ul>
          ...
          <p>
            General Outline, Inc. operates the website getoutline.com
            – henceforth referred to as "Outline". It is Outline’s policy to
          ...
          <p>
            ...
            identifying information is to better understand how Outline’s
            visitors use its website. From time to time, Outline may release
          ...
          <p>
            Certain visitors to Outline’s websites choose to interact with
            Outline in ways that require Outline to gather
            personally-identifying information. The amount and type of
            information that Outline gathers depends on the nature of the
            interaction. For example, we ask visitors who sign up to provide an
            email address or get it with authentication partner. Those who
            engage in transactions with Outline are asked to provide additional
            ...
            Outline collects such information only insofar as is necessary or
            appropriate to fulfill the purpose of the visitor’s interaction with
            Outline. Outline does not disclose personally-identifying
          ...
          <p>
            ...
            websites. For instance, Outline may monitor the most popular links
            or screen the links help identify spam. Outline may display this
          ...
          <p>
            ...
            country; by using Outline’s websites, you consent to the transfer of
            such information to them. Outline will not rent or sell potentially
            ...
            request, or when Outline believes in good faith that disclosure is
            reasonably necessary to protect the property or rights of Outline,
            third parties or the public at large.
          </p>
          <p>
            If you are a registered user of an Outline website and have supplied
            your email address, Outline may occasionally send you an email to
            tell you about new features, solicit your feedback, or just keep you
            up to date with what’s going on with Outline and our products. We
            ...
            support other users. Outline takes all measures reasonably necessary
          ...
          <p>
            ...
            and their website access preferences. Outline visitors who do not
            wish to have cookies placed on their computers should set their
            browsers to refuse cookies before using Outline’s websites, with the
            drawback that certain features of Outline’s websites may not
          ...
          <p>
            ...
            transfers may occur, and that any acquirer of Outline may continue
          ...
          <p>
            ...
            <a href="http://www.automattic.com/privacy">Automattic</a> Privacy Policy
          </p>
        </div>
      </div>
      <style jsx>
